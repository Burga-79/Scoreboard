...
document.getElementById("saveResults").addEventListener("click", () => {
  ...
  data.results.scoreA = Number(document.getElementById("scoreA").value);
  data.results.scoreB = Number(document.getElementById("scoreB").value);
...
document.getElementById("saveAll").addEventListener("click", () => {
  ...
  data.backgrounds.intervalSeconds = Number(document.getElementById("bgInterval").value);
  data.backgrounds.overlay = Number(document.getElementById("bgOverlay").value);
...
function render() {
  ...
  data.logos.sponsors.forEach((s, i) => {
  ...
  bgList.innerHTML = "";
  data.backgrounds.images.forEach((b, i) => {
    const img = document.createElement("img");
